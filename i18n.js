...
window.I18N = (() => {
  ...
  const copy = {
    zh: {
      ...
      haunt: {
        chapter: "異常紀錄 / 02:17", notificationLabel: "遊戲內通知", notificationTitle: ({ name }) => `${name} · 剛剛`,
        notificationSaved: ({ name, message }) => `通知殘留 · ${name}\n${message}`,
        scene: { connected: "連線中", listening: "有人在聽", imitating: "正在學你", quiet: "訊號正常", inside: "已在裡面", sealed: "紀錄封存" },
        sent: "已送出", read: ({ count }) => `已讀 ${count}`, unread: "已讀人數：0 · 對方仍在回覆",
        warning: "如果它問你『還在嗎』，不要回答。\n它不是在確認你有沒有看見。",
        withdrawn: "這則訊息已被撤回。", notMe: "……我沒有按撤回。\n剛剛那句，你有看到嗎？",
        seventhReader: "等一下。\n六個人的群組，為什麼你的訊息有七個已讀？",
        privateWarning: "先別相信阿森。剛剛那句警告，不是從他的帳號發出的。",
        noPrivateMessage: "你說我私訊了你？\n我一直在這裡，根本沒有切出去。",
        fromTomorrow: "明天你會忘記這段。\n所以我先用你的名字，把這句留下。",
        sealed: "群組紀錄已封存。\n最後一位真人仍未離線。",
        repeat: ["又是同一句。\n你在確認鍵盤還聽不聽你的？", "不用重複。\n它已經學會這句了。換一句，趁還來得及。"],
        routes: {
          door: { first: "你提到門以後，\n我耳機裡多了三下敲門聲。", second: "第一下，是要你注意。\n第二下，是在等你靠近。\n第三下沒有敲。因為你已經回答了。", third: "你先別回答它。\n我剛才聽到那三下，是從通話的另一端敲回來的。", last: "門外終於安靜了。\n現在，輪到裡面的那個敲門。", afterword: "你提到的那扇門，成了它反覆回來的地方。" },
          mirror: { first: "你說螢幕裡有倒影？\n我這邊的頭像，剛才比你的訊息早動了一下。", second: "黑掉的螢幕，不一定是在反光。\n也可能只是另一個畫面，暫時沒有開燈。", third: "兩個帳號都說自己沒有動。\n可是我看見其中一個，正在學另一個眨眼。", last: "畫面亮起來以後，\n留在黑暗裡的那個，終於不用再模仿。", afterword: "你一直確認倒影。它因此學會了該看向哪裡。" },
          archive: { first: "你在找紀錄？\n你的第一句話，底下多了一個昨天的時間。", second: "你以為時間錯了。\n其實錯的是訊息出現的順序。", third: "我重新整理紀錄了。\n它的回覆還在。你的問題，卻變成明天才送出。", last: "紀錄不會替你作證。\n因為第一個修改紀錄的人，用的就是你的名字。", afterword: "你查到的每個時間，都比你做出決定更早。" },
          presence: { first: "它一直顯示正在輸入。\n可是游標停的位置，跟你的帳號一模一樣。", second: "我沒有讀到你沒送出的字。\n我只是在等。你每一次停頓，都剛好留了一個空位。", third: "你們剛剛都停下來了。\n那現在替群組打字的，是誰？", last: "你以為空白是沒有人說話。\n其實是所有人，都在等你把位置讓出來。", afterword: "你沒有替它取名字。它就一直沿用你的代號。" },
        },
      },
      identity: {
      ...
      replies: {
        command: ["這裡沒有管理員。\n你剛才那段指令，只是它收到的另一則訊息。", "規則沒有被改掉。\n倒是發指令的人，多了一個。", "你可以命令這個視窗。\n可是回覆你的，不在指令裡。"],
    ...
    en: {
      ...
      haunt: {
        chapter: "ANOMALY LOG / 02:17", notificationLabel: "In-game notification", notificationTitle: ({ name }) => `${name} · just now`,
        notificationSaved: ({ name, message }) => `Notification fragment · ${name}\n${message}`,
        scene: { connected: "CONNECTED", listening: "LISTENING", imitating: "LEARNING YOU", quiet: "SIGNAL NORMAL", inside: "ALREADY INSIDE", sealed: "ARCHIVED" },
        sent: "Sent", read: ({ count }) => `Read by ${count}`, unread: "Read by 0 · They are still replying",
        warning: "If it asks whether you're still there, don't answer.\nIt isn't checking whether you saw the message.",
        withdrawn: "This message was withdrawn.", notMe: "…I didn't withdraw that.\nDid you see what I wrote?",
        seventhReader: "Wait.\nSix members. Why has your message been read by seven?",
        privateWarning: "Don't trust Sen yet. That warning didn't come from his account.",
        noPrivateMessage: "I sent you a private message?\nI've been here the whole time. I never switched screens.",
        fromTomorrow: "Tomorrow you'll forget this.\nSo I'm leaving this message in your name first.",
        sealed: "Group archive sealed.\nThe last human has not disconnected.",
        repeat: ["The same words again.\nChecking whether the keyboard still obeys you?", "No need to repeat it.\nIt has learned that line. Try another, while you still can."],
        routes: {
          door: { first: "After you mentioned a door,\nI heard three knocks through my headphones.", second: "The first knock was for your attention.\nThe second was to bring you closer.\nThere was no third. You had already answered.", third: "Don't answer it yet.\nThose three knocks just came back from the other end of the call.", last: "It's finally quiet outside the door.\nNow the one inside gets to knock.", afterword: "The door you mentioned became the place it kept returning to." },
          mirror: { first: "You mentioned a reflection?\nYour profile picture moved a moment before your message arrived.", second: "A dark screen isn't always reflecting.\nIt could be another room with its lights switched off.", third: "Both accounts say they haven't moved.\nBut one of them is learning to blink like the other.", last: "When the screen lights up,\nthe one left in the dark no longer has to imitate you.", afterword: "You kept checking the reflection. It learned where to look." },
          archive: { first: "Checking the records?\nYour first message has another timestamp underneath. Yesterday's.", second: "You think the clock is wrong.\nIt's the order of the messages that's wrong.", third: "I refreshed the archive.\nIts reply is still here. Your question now says it arrives tomorrow.", last: "The archive won't testify for you.\nThe first person to change it was using your name.", afterword: "Every timestamp you checked came before your decision." },
          presence: { first: "It keeps saying they're typing.\nBut their cursor stops at exactly the same place as yours.", second: "I haven't read your unsent words.\nI'm only waiting. Every pause leaves a space for someone else.", third: "Both of you stopped.\nWho's still typing for the group?", last: "You thought the blank space meant nobody was speaking.\nEveryone was waiting for you to give up your place.", afterword: "You never gave it another name. It kept using your alias." },
        },
      },
      identity: {
      ...
      replies: {
        command: ["There is no administrator here.\nYour command is just another message it received.", "The rules haven't changed.\nBut there are two people giving commands now.", "You can give orders to this window.\nWhatever is replying isn't part of that command."],
